...
public class Example {
  public static void main(String[] args) throws IOException, ApiException {
    ...
    ComGithubKubeflowTfOperatorPkgApisTensorflowV1alpha2TFJobList list =
        api.listTFJobForAllNamespaces(null, null, null, null, null, null, null, null, null);
    for (ComGithubKubeflowTfOperatorPkgApisTensorflowV1alpha2TFJob item : list.getItems()) {
